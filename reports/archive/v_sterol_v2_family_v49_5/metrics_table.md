...
| hierarchical | 0.892 ± 0.014 | 0.985 ± 0.006 | 0.973 | 0.935 | 0.853 | 0.991 |
...
|---|---|---|---|
| hierarchical | 0.724 ± 0.014 | 0.604 ± 0.034 | 0.893 |

### Per-class F1 (mean across iterations)

| model | ADN | B12 | BGC | CLR | COA | MYR | OLA | PLM | PP | STE |
|---|---|---|---|---|---|---|---|---|---|---|
| hierarchical | 0.788 | 0.859 | 0.761 | 0.685 | 0.846 | 0.636 | 0.485 | 0.616 | 0.969 | 0.596 |
