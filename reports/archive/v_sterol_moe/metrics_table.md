...
| composite | 0.895 ± 0.018 | 0.986 ± 0.004 | 0.974 | 0.941 | 0.854 | 0.992 |
...
|---|---|---|---|
| composite | 0.721 ± 0.019 | 0.614 ± 0.034 | 0.889 |

### Per-class F1 (mean across iterations)

| model | ADN | B12 | BGC | CLR | COA | MYR | OLA | PLM | PP | STE |
|---|---|---|---|---|---|---|---|---|---|---|
| composite | 0.790 | 0.808 | 0.741 | 0.695 | 0.829 | 0.669 | 0.515 | 0.613 | 0.968 | 0.581 |
