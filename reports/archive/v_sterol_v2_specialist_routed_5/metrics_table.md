...
| hierarchical | 0.893 ± 0.018 | 0.985 ± 0.006 | 0.973 | 0.934 | 0.856 | 0.991 |
...
|---|---|---|---|
| hierarchical | 0.731 ± 0.012 | 0.617 ± 0.031 | 0.895 |

### Per-class F1 (mean across iterations)

| model | ADN | B12 | BGC | CLR | COA | MYR | OLA | PLM | PP | STE |
|---|---|---|---|---|---|---|---|---|---|---|
| hierarchical | 0.788 | 0.856 | 0.761 | 0.717 | 0.847 | 0.652 | 0.513 | 0.637 | 0.969 | 0.568 |
