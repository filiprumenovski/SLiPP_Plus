...
| exp-028-compact-shape3-shell6-chem-weighted | 0.1*(v49+tunnel_shape3) + 0.2*(v14+aa20+shell6+tunnel_shape) + 0.7*(v49+tunnel_chem) | 0.903 ± 0.016 | 0.769 ± 0.019 | 0.717 | 0.724 | NEW DEPLOYABLE LEADER. | exp-035-legacy-rescue-logistic-gate-reproducible |
...
| exp-042-structure-grouped-family-encoder-negative | v49+tunnel_shape3 | 0.894 ± 0.009 | 0.607 ± 0.019 | 0.712 | 0.68 | NEGATIVE GROUPED-SPLIT RESULT. | - |
