...
- `src/slipp_plus/publication_figures.py` and `tools/build_publication_figures.py`: a five-figure publication set rendered to `figures/` in PNG / PDF / SVG, including a direct upgrade over Chou et al. 2024 Fig. 7.
